...
class Status(threading.Thread):
    ...
    def __init__(self):
        ...
        self.dream_min_duration_minutes = 120  # Minimum time dream stays before it can dissipate (in minutes)
        self.dream_dissipation_check_interval = 300  # How often to check for dream dissipation (in seconds, 5 minutes)
        self.dream_dissipation_probability = 0.15  # Probability per check that dream will dissipate (15% chance per 5-minute check)
        ...
        self.dream_recall_attempted = False  # Whether we've already attempted to recall the dream (recall-once gate)
