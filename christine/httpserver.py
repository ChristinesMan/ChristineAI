...
#     broca.thread.queue_sound(sound=sounds.database.get_sound(sound_id=sound_id), play_no_wait=True)
...
#     new_sound_id = sounds.database.new_sound(newname)
#     sounds.database.reprocess(new_sound_id)
#     broca.thread.queue_sound(sound=sounds.database.get_sound(sound_id=new_sound_id), play_no_wait=True)
#     return "coolthxbai"
...
#     sound_id = request.forms.get("sound_id")
#     sounds.database.del_sound(sound_id=sound_id)
#     return "executed"
...
#     sounds.database.update(sound_id=sound_id, base_volume_adjust=volume)
#     sounds.database.reprocess(sound_id=sound_id)
#     broca.thread.queue_sound(sound=sounds.database.get_sound(sound_id=sound_id), play_no_wait=True)
#     return "done"
...
#     sounds.database.update(sound_id=sound_id, proximity_volume_adjust=volume)
#     return "done"
...
#     sounds.database.update(sound_id=sound_id, intensity=intensity)
#     return "done"
...
#     sounds.database.update(sound_id=sound_id, cuteness=cuteness)
#     return "done"
...
#     sounds.database.update(sound_id=sound_id, tempo_range=tempo_range)
#     sounds.database.reprocess(sound_id=sound_id)
#     return "done"
...
#     sounds.database.update(sound_id=sound_id, replay_wait=replay_wait)
#     return "done"
...
#         collectionstate,
#     )
#     sounds.database.collection_update(
