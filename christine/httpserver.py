...
def posthoneysay():
    ...
    broca.thread.queue_sound(sound=sounds.soundsdb.get_sound(sound_id=sound_id), play_no_wait=True)
...
def postnewsound():
    ...
    broca.thread.queue_sound(sound=sounds.soundsdb.get_sound(sound_id=new_sound_id), play_no_wait=True)
    return "coolthxbai"
